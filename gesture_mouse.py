...
# hand_movements = HandMovements(
#     screen_proportion=args.screen_proportion, len_moving_average=args.len_moving_average)
# delay = Delay(hand_pose.classifier.classes_, moving_average=args.moving_average,
